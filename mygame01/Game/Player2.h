...
public:
	...
	ModelRender m_player2; //モデル
	Vector3 m_position; //プレイヤー2の位置
	Vector3 m_noMovePosition; //画面端に行ったときの位置
	Vector3 m_repulsion; //反発(画面端用)
	Vector3 m_moveSpeed; //プレイヤー2の速度
	...
	Quaternion m_rotation; //プレイヤー2の方向
	...
	int m_gamepadNo = 1; //ゲームパッド何番目？
	bool m_startFlag = false; //初めて移動したか？
	//int m_finishflag = 0;
	int m_playerHP = 100; //プレイヤー2の体力
	int m_playerMaxHP = 100; //プレイヤー2の最大体力
